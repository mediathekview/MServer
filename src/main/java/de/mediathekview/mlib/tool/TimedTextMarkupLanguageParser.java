...
public class TimedTextMarkupLanguageParser {
    ...
    public boolean parse(Path ttmlFilePath) {
        ...
        try {
            ...
            de.mediathekview.mlib.tool.Log.errorLog(912036478, new String[]{ex.getLocalizedMessage(), "File: " + ttmlFilePath});
            ret = false;
        }
        return ret;
    }
    ...
    public boolean parseXmlFlash(Path ttmlFilePath) {
        ...
        try {
            ...
            de.mediathekview.mlib.tool.Log.errorLog(46231470, new String[]{ex.getLocalizedMessage(), "File: " + ttmlFilePath});
            ret = false;
        }
        return ret;
    }
