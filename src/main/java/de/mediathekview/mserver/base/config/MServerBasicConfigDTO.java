...
/**
 * The basic configs which can be set for all {@link de.mediathekview.mlib.daten.Sender} and can be overwritten for particular one.
 */
public class MServerBasicConfigDTO
{
     ...
     * <br>
     * <b>Example:</b> If a Sendung overview side has 10 pages with videos for this Sendung and
    ...
    public boolean equals(final Object aO)
    {
        ...
        if (getMaximumCrawlDurationInMinutes() != null ? !getMaximumCrawlDurationInMinutes().equals(that.getMaximumCrawlDurationInMinutes()) : that.getMaximumCrawlDurationInMinutes() != null)
            return false;
        if (getMaximumSubpages() != null ? !getMaximumSubpages().equals(that.getMaximumSubpages()) : that.getMaximumSubpages() != null)
            return false;
        return getMaximumDaysForSendungVerpasstSection() != null ? getMaximumDaysForSendungVerpasstSection().equals(that.getMaximumDaysForSendungVerpasstSection()) : that.getMaximumDaysForSendungVerpasstSection() == null;
    }
