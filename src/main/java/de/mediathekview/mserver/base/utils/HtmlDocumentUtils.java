...
public final class HtmlDocumentUtils {
	...
	/**
	 * Searches for the given selector if found it returns the given attribute of
	 * the first result.
	 *
	 ...
	 *         {@link Optional}.
	 */
	public static Optional<String> getElementAttributeString(final String aElementSelector, final String aAttributeKey,
	...
	/**
	 * Searches for the given selector if found it returns the attribute of the
	 * first result.
	 *
	 ...
	 *         {@link Optional}.
	 */
	public static Optional<String> getElementAttributeString(final String aElementSelector1,
			final String aElementSelector2, final String aAttributeKey, final Document aDocument) {
	 ...
	 *         {@link Optional}.
	 */
	public static Optional<String> getElementString(final String aElementSelector, final Document aDocument) {
		final Elements selected = aDocument.select(aElementSelector);
		if (!selected.isEmpty()) {
