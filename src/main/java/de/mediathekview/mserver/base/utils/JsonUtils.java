...
public final class JsonUtils {
   ...
   * Example: If the tree is MainObj -> FirstChild -> SecondChild and the given JsonElement is
   * MainObj and the element IDs are "FirstChild,SecondChild" this will return true.
   *
  ...
  public static boolean checkTreePath(final JsonElement aJsonElement,
      final Optional<AbstractCrawler> aCrawler, final String... aElementIds) {
