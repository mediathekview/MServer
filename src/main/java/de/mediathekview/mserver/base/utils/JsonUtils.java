...
public final class JsonUtils {
	...
	/**
	 * Checks if a JSON tree path outgoing from the first JsonElement is correct and
	 * all given element IDs exist in the given order.<br>
	 ...
	 * @param aCrawler     The crawler which using this. If it's given and a element
	 *                     is missing the
	 *                     {@link AbstractCrawler#printMissingElementErrorMessage(String)}
	 *                     will be called for it.
	 * @param aElementIds  The tree-childs in the order in which they should be
	 *                     checked.
	 * @return true if the JSON tree path is correct and all given element IDs exist
	 *         in the given order.
	 */
	public static boolean checkTreePath(final JsonElement aJsonElement, final Optional<AbstractCrawler> aCrawler,
	 ...
	 * @param aCrawler     The crawler which runs this task. When given and a given
	 *                     element is missing the error counter will be increased
	 *                     and a debug message will be printed.
	 * @param aElementIds  The elements which it should has.
	 * @return true when the element is a {@link JsonObject} and if it has all given
	 *         elements and if no element is null.
	 */
	public static boolean hasElements(final JsonElement aJsonElement,
		...
		return aJsonElement.isJsonObject() && hasElements(aJsonElement.getAsJsonObject(), aCrawler, aElementIds);
	}
	...
	/**
	 * Checks if the {@link JsonObject} has all given elements and if no element is
	 * null.
	 *
	 * @param aJsonObject The object to check.
	 * @param aCrawler    The crawler which runs this task. When given and a given
	 *                    element is missing the error counter will be increased and
	 *                    a debug message will be printed.
	 * @param aElementIds The elements which it should has.
	 * @return true when the object has all given elements and if no element is
	 *         null.
	 */
	public static boolean hasElements(final JsonObject aJsonObject, final Optional<? extends AbstractCrawler> aCrawler,
			final String... aElementIds) {
		for (final String elementId : aElementIds) {
