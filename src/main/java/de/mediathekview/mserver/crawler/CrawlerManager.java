...
public class CrawlerManager extends AbstractManager {
  ...
  private void initializeCrawler(final MServerConfigManager rootConfig) {
    ...
    crawlerMap.put(
        Sender.MDR, new MdrCrawler(forkJoinPool, messageListeners, progressListeners, rootConfig));
    crawlerMap.put(
        Sender.NDR, new NdrCrawler(forkJoinPool, messageListeners, progressListeners, rootConfig));
    crawlerMap.put(
    ...
    crawlerMap.put(
        Sender.RBB, new RbbCrawler(forkJoinPool, messageListeners, progressListeners, rootConfig));
    crawlerMap.put(
