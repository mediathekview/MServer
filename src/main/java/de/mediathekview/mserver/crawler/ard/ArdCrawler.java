...
public class ArdCrawler extends AbstractCrawler {
  ...
  private ConcurrentLinkedQueue<CrawlerUrlDTO> createDayUrlsToCrawl() {
    ...
    for (int i = 0; i < crawlerConfig.getMaximumDaysForSendungVerpasstSection() + crawlerConfig.getMaximumDaysForSendungVerpasstSectionFuture(); i++) {
  ...
  protected RecursiveTask<Set<Film>> createCrawlerTask() {
    ConcurrentLinkedQueue<CrawlerUrlDTO> dayUrls = createDayUrlsToCrawl();
    return null;
  }
}
