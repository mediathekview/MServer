 ...
 * {@link AbstractUrlTask#processElement(CrawlerUrlDTO)} for each.
 *
 ...
 */
public abstract class AbstractUrlTask<T, D extends CrawlerUrlDTO> extends AbstractRecrusivConverterTask<T, D> {
