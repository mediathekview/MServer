...
public class BrSendungsFolgenTask implements Callable<Set<String>> {
  ...
  public Set<String> call() throws Exception {
    ...
    final Gson gson = new GsonBuilder()
        .registerTypeAdapter(BrIdsDTO.class, new BrSendungsFolgenDeserializer()).create();
    ...
    final String response = target.request(MediaType.APPLICATION_JSON_TYPE).post(Entity.entity(
        String.format(QUERY_TEMPLATE, sendungsReihenId, folgenCount, folgenCount, todayDateString),
        MediaType.APPLICATION_JSON_TYPE), String.class);
    final BrIdsDTO sendungsFolgen = gson.fromJson(response, BrIdsDTO.class);
