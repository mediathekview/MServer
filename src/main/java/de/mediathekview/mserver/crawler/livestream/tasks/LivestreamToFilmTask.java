...
public class LivestreamToFilmTask extends AbstractRecursiveConverterTask<Film, TopicUrlDTO>{
  ...
  static {
    ...
    senderLookup.put("arte im Livestream",new SenderInfo(Sender.ARTE_DE, "arte im Livestream", false));
    senderLookup.put("ARTE Livestream französisch",new SenderInfo(Sender.ARTE_FR, "ARTE Livestream (FR)", true));
    senderLookup.put("ARTE Livestream",new SenderInfo(Sender.ARTE_DE, "ARTE Livestream (DE)", true));
    senderLookup.put("BR Fernsehen Nord",new SenderInfo(Sender.BR, "BR Fernsehen Nord Livestreamn", true));
    senderLookup.put("BR Fernsehen Süd",new SenderInfo(Sender.BR, "BR Fernsehen Süd Livestreamn", true));
    senderLookup.put("Das Erste",new SenderInfo(Sender.ARD, "Das Erste Livestreamn", true));
    senderLookup.put("Das ZDF im Livestream",new SenderInfo(Sender.ZDF, "ZDF Livestream", true));
    senderLookup.put("Deutsche Welle (DW) - Die mediale Stimme Deutschlands",new SenderInfo(Sender.DW, "Deutsche Welle (DW) Livestreamn", true));
    senderLookup.put("hr-fernsehen",new SenderInfo(Sender.HR, "HR-fernsehen Livestreamn", true));
    ...
    senderLookup.put("MDR Fernsehen Sachsen-Anhalt",new SenderInfo(Sender.MDR, "MDR Fernsehen Sachsen-Anhalt Livestream", true));
    senderLookup.put("MDR Fernsehen Thüringen",new SenderInfo(Sender.MDR, "MDR Fernsehen Thüringen Livestream", true));
    senderLookup.put("NDR Fernsehen Hamburg",new SenderInfo(Sender.NDR, "NDR Fernsehen Hamburg Livestream", true));
    senderLookup.put("NDR Fernsehen Mecklenburg-Vorpommern",new SenderInfo(Sender.NDR, "NDR Fernsehen Mecklenburg-Vorpommern Livestream", true));
    senderLookup.put("NDR Fernsehen Schleswig-Holstein",new SenderInfo(Sender.NDR, "NDR Fernsehen Schleswig-Holstein Livestream", true));
    senderLookup.put("NDR Fernsehen",new SenderInfo(Sender.NDR, "NDR Fernsehen Livestream", true));
    ...
    senderLookup.put("Phoenix im Livestream",new SenderInfo(Sender.PHOENIX, "Phoenix im Livestream", false));
    senderLookup.put("phoenix live",new SenderInfo(Sender.PHOENIX, "Phoenix Livestream", true));
    senderLookup.put("rbb Fernsehen Berlin",new SenderInfo(Sender.RBB, "rbb Fernsehen Berlin Livestream", true));
    senderLookup.put("rbb Fernsehen Brandenburg",new SenderInfo(Sender.RBB, "rbb Fernsehen Brandenburg Livestream", true));
    ...
    senderLookup.put("SWR Fernsehen Baden-Württemberg",new SenderInfo(Sender.SWR, "SWR Fernsehen Baden-Württemberg Livestream", true));
    senderLookup.put("SWR Fernsehen Rheinland-Pfalz",new SenderInfo(Sender.SWR, "SWR Fernsehen Rheinland-Pfalz Livestream", true));
    senderLookup.put("tagesschau24-Livestream",new SenderInfo(Sender.TAGESSCHAU24, "tagesschau24 Livestream", true));
    senderLookup.put("WDR Fernsehen im Livestream",new SenderInfo(Sender.WDR, "WDR Fernsehen Livestream", true));
    senderLookup.put("ZDFinfo im Livestream",new SenderInfo(Sender.ZDF, "ZDFinfo Livestream", true));
    senderLookup.put("ZDFneo im Livestream",new SenderInfo(Sender.ZDF, "ZDFneo Livestream", true));
  }
