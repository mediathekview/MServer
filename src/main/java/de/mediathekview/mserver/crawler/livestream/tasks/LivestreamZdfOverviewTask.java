...
public class LivestreamZdfOverviewTask extends AbstractJsonRestTask<TopicUrlDTO, Set<TopicUrlDTO>, CrawlerUrlDTO> {
  private static final long serialVersionUID = -1203126035944523033L;
  private static final Logger LOG = LogManager.getLogger(LivestreamZdfOverviewTask.class);
  
  public LivestreamZdfOverviewTask(AbstractCrawler crawler, Queue<CrawlerUrlDTO> urlToCrawlDTOs) {
    super(crawler, urlToCrawlDTOs, null);
  }

  @Override
  protected JsonDeserializer<Set<TopicUrlDTO>> getParser(CrawlerUrlDTO aDTO) {
    return new LivestreamZdfDeserializer();
  }
  ...
  protected AbstractRecursiveConverterTask<TopicUrlDTO, CrawlerUrlDTO> createNewOwnInstance(
    ...
    return new LivestreamZdfOverviewTask(crawler, aElementsToProcess);
  }
