...
public class SrfSendungenOverviewJsonDeserializer implements JsonDeserializer<Set<CrawlerUrlDTO>> {
  ...
  private static final Logger LOG =
      LogManager.getLogger(SrfSendungenOverviewJsonDeserializer.class);
  ...
  public Set<CrawlerUrlDTO> deserialize(
      JsonElement aJsonElement, Type aType, JsonDeserializationContext aJdc)
  ...
  private Optional<String> parseEntry(JsonObject entryObject) {
    if (entryObject.has(ELEMENT_ID)) {
      ...
      String url = urlBuilder.buildUrl(SrfConstants.BASE_URL, id);
