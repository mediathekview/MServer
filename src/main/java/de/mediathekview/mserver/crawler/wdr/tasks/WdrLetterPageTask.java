...
public class WdrLetterPageTask implements Callable<Queue<WdrTopicUrlDto>> {
  ...
  public Queue<WdrTopicUrlDto> call() {
    final Queue<WdrTopicUrlDto> results = new ConcurrentLinkedQueue<>();
  ...
  private void parseSubPage(final Queue<WdrTopicUrlDto> aResults, final Document aDocument) {
