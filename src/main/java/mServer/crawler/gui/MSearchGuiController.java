/*
 * MediathekView Copyright (C) 2016 W. Xaver W.Xaver[at]googlemail.com
...
public class MSearchGuiController implements Initializable {
  ...
  private void initPanelGui() {
    if (Data.pathFilmlist.isEmpty()) {
      txtFilmList.setText(System.getProperty("user.home") + File.separator + ".mediathek3"
          + File.separator + "filme.json");
    } else {
      txtFilmList.setText(Data.pathFilmlist);
    }
    Data.listeFilme
        .addAll(new FilmlisteLesen().readFilmListe(txtFilmList.getText(), 0 /* all days */));
    ...
    // WriteFilmlistJson().filmlisteSchreibenJson(txtFilmList.getText(), Data.listeFilme));
