...
public class MediathekArd extends MediathekReader implements Runnable {
	...
	private void feedSuchen1(String strUrlFeed) {
		...
		seiteFeed = getUrlIo.getUri(SENDERNAME, strUrlFeed, Const.KODIERUNG_UTF,
	...
	private class ThemaLaden implements Runnable {
		...
		private void filmSuchen1(String strUrlFeed, String thema, boolean weiter) {
			...
			while (!Config.getStop() && (pos = seite1.indexOf(MUSTER, pos)) != -1) {
				...
				if (!CrawlerTool.loadLongMax()) {
					if (count > 5 && !THEMA_ALPHA_CENTAURI.equalsIgnoreCase(thema)) {
						break;
					}
				}
				pos += MUSTER.length();
			...
			if (!Config.getStop() && weiter
					&& (CrawlerTool.loadLongMax() || thema.equalsIgnoreCase(THEMA_ALPHA_CENTAURI))) {
				// dann gehts weiter
				int maxWeiter = 0;
				int maxTh = 10;
		...
		private void filmSuchen2(String urlFilm_, String thema, String titel, long dauer, String datum, String zeit,
				String urlSendung) {
			// URL bauen:
		...
		private void filmSuchen_old(String urlSendung, String thema, String titel, long dauer, String datum,
				String zeit) {
			// für ganz alte Sachen:
			/*
			 * </li><li
			 * data-ctrl-21282662-28534346-trigger="{&#039;xt_obj&#039;:{&#039;
			 * href&#039;
			 * :&#039;http://cdn-vod-ios.br.de/i/mir-live/bw1XsLzS/bLQH/
			 * bLOliLioMXZhiKT1/uLoXb69zbX06/MUJIuUOVBwQIb71S/
			 * bLWCMUJIuUOVBwQIb71S/_2rp9U1S/_-J
			 * S/_-4y5H1S/bc3757a9-1cfd-4aaa-a963-51e9fd0095f2_,0,A,B,E,C,.mp4.
			 * csmil/master.m3u8?__b__=200&#039;,&#039;target&#039;:&#039;_self&
			 * #039;},&#039;redirect&#0 39;:{&#039;name&#039;:&#039;br&#039;}}">
			 */
			try {
				meldung(urlSendung);
