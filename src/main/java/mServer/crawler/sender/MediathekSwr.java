...
public class MediathekSwr extends MediathekReader
{
    ...
    private void addToList__()
    {
        ...
        strSeite = getUrlIo.getUriWithDelay(SENDER.getName(), "http://swrmediathek.de/tvlist.htm", StandardCharsets.UTF_8, 2, strSeite, "", 4, TimeUnit.SECONDS);
        int pos = 0;
        String url;
        String thema;
    ...
    private void addToList_verpasst()
    {
        ...
        MSStringBuilder strSeite = new MSStringBuilder(Const.STRING_BUFFER_START_BUFFER);
        GetUrl getUrlIo = new GetUrl(getWartenSeiteLaden());
        strSeite = getUrlIo.getUriWithDelay(SENDER.getName(), "http://swrmediathek.de/sendungverpasst.htm", StandardCharsets.UTF_8, 2, strSeite, "", 4, TimeUnit.SECONDS);
    ...
    private class ThemaLaden extends Thread
    {
        ...
        private void themenSeitenSuchen(String strUrlFeed, String thema)
        {
            ...
            strSeite1 = getUrlThemaLaden.getUriWithDelay(SENDER.getName(), strUrlFeed, StandardCharsets.UTF_8, 2 /* versuche */, strSeite1, thema, 4, TimeUnit.SECONDS);
        ...
        private void json(String strUrlFeed, String thema, String urlJson)
        {
            ...
            try
            {
                strSeite2 = getUrlThemaLaden.getUriWithDelay(SENDER.getName(), urlJson, StandardCharsets.UTF_8, 1, strSeite2, "", 4, TimeUnit.SECONDS);
