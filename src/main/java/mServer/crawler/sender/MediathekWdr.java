...
public class MediathekWdr extends MediathekReader
{
    ...
    private void rockpalast()
    {
        try
        {
            ...
            seite_1 = getUrlIo.getUri(SENDER.getName(), ROCKPALAST_URL, StandardCharsets.UTF_8, 3 /* versuche */, seite_1, "");
    ...
    private void maus()
    {
        ...
        GetUrl getUrlIo = new GetUrl(getWartenSeiteLaden());
        seite_1 = getUrlIo.getUri(SENDER.getName(), MAUS, StandardCharsets.UTF_8, 3 /* versuche */, seite_1, "");
        try
        {
    ...
    private void festival()
    {
        ...
        GetUrl getUrlIo = new GetUrl(getWartenSeiteLaden());
        seite_1 = getUrlIo.getUri(SENDER.getName(), ROCKPALAST_FESTIVAL, StandardCharsets.UTF_8, 3 /* versuche */, seite_1, "");
        try
        {
        ...
        private void addFilm2(String filmWebsite, String thema, String titel, String urlFilmSuchen, long dauer, String datum, String beschreibung)
        {
            ...
            if (!urlNorm.isEmpty())
            {
                if (thema.endsWith(SENDER.getName()))
                {
                    ...
                    Film f = mlibFilmeSuchen.listeFilmeNeu.getFilmByUrl(urlNorm);
                    if (f != null)
                    {
                        return;
                    }
