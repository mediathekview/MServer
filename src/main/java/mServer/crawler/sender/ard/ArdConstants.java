...
public class ArdConstants {
  ...
  public static final String TOPIC_COMPILATION_PAGE_URL = API_URL + "/page-gateway/widgets/%s/compilation/%s?pageNumber=%d&pageSize=%d";
  ...
  public static final int MAX_COMPILATION_SUB_PAGES = 4;
