...
public class ArteFilmDeserializer implements JsonDeserializer<Optional<ArteFilmDto>> {
  ...
  public ArteFilmDeserializer(final String sender, final LocalDateTime today) {
    this.sender = sender;
    this.today = today;
  }

  @Override
  public Optional<ArteFilmDto> deserialize(
    ...
    if (aJsonElement.isJsonObject()
      ...
      final ArteFilmDto film =
              new ArteFilmDto(sender, thema, titel, date.orElse(null), duration, beschreibung, urlWeb);
