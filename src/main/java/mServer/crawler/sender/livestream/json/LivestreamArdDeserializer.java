package mServer.crawler.sender.livestream.json;
...
import mServer.crawler.sender.livestream.LivestreamConstants;
...
public class LivestreamArdDeserializer implements JsonDeserializer<Set<TopicUrlDTO>> {
  ...
  public Set<TopicUrlDTO> deserialize(final JsonElement aJsonElement, final Type aType,
    ...
    if (JsonUtils.checkTreePath(aJsonElement, TAG_SECTIONS)) {
      ...
      if (jsonTagSections.isJsonArray() &&
        ...
        if (JsonUtils.checkTreePath(jsonTagSection, TAG_MODCONS)) {
          ...
          if (jsonTagModCons.isJsonArray() &&
            ...
            if (JsonUtils.checkTreePath(jsonTagModCon, TAG_MODS)) {
              ...
              if (jsonTagMods.isJsonArray() &&
                ...
                if (JsonUtils.checkTreePath(jsonTagMod, TAG_INHALTE)) {
                  ...
                  if (jsonInhalte.isJsonArray()) {
                    for (JsonElement livestream : jsonInhalte.getAsJsonArray()) {
                      ...
                      if (JsonUtils.checkTreePath(livestream, TAG_INHALTE_LINK)) {
                        JsonElement jsonTagLink = livestream.getAsJsonObject().get(TAG_INHALTE_LINK);
                        if (JsonUtils.checkTreePath(jsonTagLink, TAG_INHALTE_URL)) {
