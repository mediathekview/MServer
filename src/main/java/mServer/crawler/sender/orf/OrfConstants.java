...
public final class OrfConstants {
  ...
  /**
   * URL für die Sendungen eines Tages Muss am Ende noch um das Datum dd.MM.yyyy
   * ergänzt werden
   */
  public static final String URL_DAY = URL_BASE + "/schedule/";

  /**
   * Basis-URL für Übersichtsseite nach Buchstaben Muss am Ende noch um
   * Buchstabe bzw. 0 ergänzt werden
   */
  ...
  /**
   * URL für verpasste Sendungen eines Tages Muss am Ende noch um Datum ergänzt
   * werden im Format DD.MM.YYYY
   */
