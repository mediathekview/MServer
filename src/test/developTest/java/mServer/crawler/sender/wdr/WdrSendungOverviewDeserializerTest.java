...
public class WdrSendungOverviewDeserializerTest {
    ...
    public WdrSendungOverviewDeserializerTest(String aHtmlFile, String[] aExpectedOverviewUrls, String[] aExpectedVideoUrls) {
        htmlFile = aHtmlFile;
