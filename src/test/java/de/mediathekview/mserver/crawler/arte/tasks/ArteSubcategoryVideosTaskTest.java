...
public class ArteSubcategoryVideosTaskTest extends ArteTaskTestBase {
  ...
  public void testOverviewWithSinglePage() {
    ...
    final Set<CrawlerUrlDTO> actual = executeTask(requestUrl, ArteLanguage.DE);
  ...
  public void testOverviewWithMultiplePagesLimitSubpagesLargerThanSubpageCount() {
    ...
    setupSuccessfulJsonResponse("/api/emac/v3/de/web/zones/videos_subcategory?id=ART&page=2&limit=5", "/arte/arte_subcategory_films_page_last.json");
  ...
  private Set<CrawlerUrlDTO> executeTask(String aRequestUrl, ArteLanguage language) {
