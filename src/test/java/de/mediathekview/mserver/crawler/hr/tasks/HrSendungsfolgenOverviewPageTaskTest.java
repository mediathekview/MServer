...
public class HrSendungsfolgenOverviewPageTaskTest extends HrTaskTestBase {
  ...
  public void test() throws IOException {
    ...
    Connection connection = JsoupMock.mock(requestUrl, "/hr/hr_topic_page1.html");
  ...
  public void testHessenschau() throws IOException {
    ...
    Connection connection = JsoupMock.mock(requestUrl, "/hr/hr_topic_page_hessenschau.html");
    when(jsoupConnection.getConnection(eq(requestUrl))).thenReturn(connection);
