...
public class MdrFilmPageDeserializerTest {
        ...
        new Object[][]{
            {
                ...
                new CrawlerUrlDTO[]{
                    new CrawlerUrlDTO(MdrConstants.URL_BASE + "/mediathek/fernsehen/video-226902-avCustom.xml")
                }
            },
            {
                "/mdr/mdr_film_with_entries.html",
                new CrawlerUrlDTO[]{
                    new CrawlerUrlDTO(MdrConstants.URL_BASE + "/mediathek/fernsehen/a-z/video-227446-avCustom.xml"),
                    new CrawlerUrlDTO(MdrConstants.URL_BASE + "/mediathek/fernsehen/a-z/video-227420-avCustom.xml"),
                    new CrawlerUrlDTO(MdrConstants.URL_BASE + "/mediathek/fernsehen/a-z/video-227440-avCustom.xml"),
                    new CrawlerUrlDTO(MdrConstants.URL_BASE + "/mediathek/fernsehen/a-z/video-227432-avCustom.xml")
                }
            },
            {
  ...
  public MdrFilmPageDeserializerTest(final String aHtmlFile, final CrawlerUrlDTO[] aExpectedFilmEntries) {
    htmlFile = aHtmlFile;
