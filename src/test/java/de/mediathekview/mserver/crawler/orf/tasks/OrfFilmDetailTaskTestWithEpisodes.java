    ...
    actual.forEach(
        actualFilm -> {
          ...
          AssertFilm.assertEquals(
              ...
              REQUEST_URL,
              EXPECTED_GEO,
              expectedData[INDEX_URL_SMALL].toString().isEmpty()
                  ? ""
                  : getWireMockBaseUrlSafe() + expectedData[INDEX_URL_SMALL].toString(),
              expectedData[INDEX_URL_NORMAL].toString().isEmpty()
                  ? ""
                  : getWireMockBaseUrlSafe() + expectedData[INDEX_URL_NORMAL].toString(),
