...
class OrfOnEpisodeTaskTest extends OrfOnEpisodesTaskTest {
  ...
  void testNoQXA() {
    ...
    assertTrue(Set.of(
        URI.create("https://api-tvthek.orf.at/assets/subtitles/0166/92/07aead27b4c0b09b36750db54b8ce15ff9b8499c.ttml").toURL(),
        URI.create("https://api-tvthek.orf.at/assets/subtitles/0166/92/4dd6932d7cf6ceaad90a536c3e03981267e32941.vtt").toURL(),
        URI.create("https://api-tvthek.orf.at/assets/subtitles/0166/92/09477f02c5e0392ecd2f717461ed136237d70050.srt").toURL(),
        URI.create("https://api-tvthek.orf.at/assets/subtitles/0166/92/808e2453d38fd8a5e4fab4794cc034ee89fcfd9c.xml").toURL(),
        URI.create("https://api-tvthek.orf.at/assets/subtitles/0166/92/8547597f31429d87a5418918ae471b44fcf9ab55.smi").toURL()
  ...
  void testUseQxaChunklists() {
    ...
    assertTrue(Set.of(
        URI.create("https://api-tvthek.orf.at/assets/subtitles/0166/92/b682365a2a3fd1d45a2f029a597735a9df5b7524.ttml").toURL(),
        URI.create("https://api-tvthek.orf.at/assets/subtitles/0166/92/20c53ed98f58a5045da663191516bc7fbf09e3d2.srt").toURL(),
        URI.create("https://api-tvthek.orf.at/assets/subtitles/0166/92/c50d4ed5c4f912e8d7f7b5e94cd9155bd31b247d.vtt").toURL(),
        URI.create("https://api-tvthek.orf.at/assets/subtitles/0166/92/1f178ebeae4aea09e03697e85082701de6df436c.xml").toURL(),
        URI.create("https://api-tvthek.orf.at/assets/subtitles/0166/92/7096926d900006d0d196e1dab952a62200118c2c.smi").toURL()
        ).containsAll(actual.getSubtitles()));
    assertEquals(Map.of(
  ...
  void testAD() {
    ...
    assertTrue(List.of(GeoLocations.GEO_AT).containsAll(actual.getGeoLocations()));
    assertTrue(Set.of(
        URI.create("https://api-tvthek.orf.at/assets/subtitles/0164/35/3c283187a44f9759f83a6731220549dc485d332d.srt").toURL(),
        URI.create("https://api-tvthek.orf.at/assets/subtitles/0164/35/d7726579282af4a4eb7f13bcd0716b0ddd769e78.vtt").toURL(),
        URI.create("https://api-tvthek.orf.at/assets/subtitles/0164/35/6146c97d9eb3437f89e05640188093453ad3e1af.smi").toURL(),
        URI.create("https://api-tvthek.orf.at/assets/subtitles/0164/35/cae06428d2dd0a03f6c0a81dbd7695f0b096187d.ttml").toURL(),
        URI.create("https://api-tvthek.orf.at/assets/subtitles/0164/35/275b919125cabcf1bbb0a3f1b38ec0c460367ae6.xml").toURL()
        ).containsAll(actual.getSubtitles()));
    // [, , , , ]
    assertEquals(Map.of(
  ...
  void testArchive() {
    ...
    assertTrue(List.of(GeoLocations.GEO_NONE).containsAll(actual.getGeoLocations()));
    assertTrue(Set.of(
        URI.create("https://api-tvthek.orf.at/assets/subtitles/0149/07/169001a65997f4d747fff2e4390a1f48789f388e.smi").toURL(),
        URI.create("https://api-tvthek.orf.at/assets/subtitles/0149/07/fcaa2c529b8a6524f2fe58820e734dba44aab0ba.ttml").toURL(),
        URI.create("https://api-tvthek.orf.at/assets/subtitles/0149/07/dacc52722cffd5bc466a231c66aeb2c01033a24d.vtt").toURL(),
        URI.create("https://api-tvthek.orf.at/assets/subtitles/0149/07/1fc835e5ea31f903e9e5aa136085d4835bb8f81f.srt").toURL(),
        URI.create("https://api-tvthek.orf.at/assets/subtitles/0149/07/f198c7d0c39a12039bd3a7f20a371acc0b7e8168.xml").toURL()
        ).containsAll(actual.getSubtitles()));
    assertEquals(Map.of(
