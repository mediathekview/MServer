...
public class RbbFilmDetailDeserializerTest {
  ...
  private final Duration expectedDuration;
    ...
    public RbbFilmDetailDeserializerTest(
            final String aRequestUrl,
            final String aHtmlPage,
            final String aExpectedVideoUrl,
  ...
  public void deserializeTest() {
    ...
    final RbbFilmDetailDeserializer target = new RbbFilmDetailDeserializer(RbbConstants.URL_BASE);
      final Optional<FilmInfoDto> actual =
              target.deserialize(new CrawlerUrlDTO(requestUrl), document);
