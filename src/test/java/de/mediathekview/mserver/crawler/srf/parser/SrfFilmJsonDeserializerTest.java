...
public class SrfFilmJsonDeserializerTest {
  ...
  public SrfFilmJsonDeserializerTest(String aJsonFile, String aM3u8File, String aM3u8Url, String aTheme, String aTitle, LocalDateTime aLocalDateTime, long aDuration, String aDescription, String aSmallUrl, String aNormalUrl, String aHdUrl, String aSubtitleUrl) {
    jsonFile = aJsonFile;
    m3u8File = aM3u8File;
    m3u8Url = aM3u8Url;
    theme = aTheme;
