...
public class SrfSendungOverviewJsonDeserializerTest {
  ...
  public static Collection<Object[]> data() {
    return Arrays.asList(new Object[][] { 
      { "/srf/srf_sendung_overview_page1.json", 
        ...
        new CrawlerUrlDTO[] {
          new CrawlerUrlDTO("https://il.srgssr.ch/integrationlayer/2.0/srf/mediaComposition/video/e3720c24-58b9-4056-b098-17acbf97f9a6.json"),
          new CrawlerUrlDTO("https://il.srgssr.ch/integrationlayer/2.0/srf/mediaComposition/video/c19eeb6c-c168-40a3-a205-4298a18576aa.json"),
          new CrawlerUrlDTO("https://il.srgssr.ch/integrationlayer/2.0/srf/mediaComposition/video/d38b05d8-20f8-409a-b1de-b8a3b4be021e.json"),
          new CrawlerUrlDTO("https://il.srgssr.ch/integrationlayer/2.0/srf/mediaComposition/video/f58c940d-89bc-4f7d-9fb4-a4634fac1b32.json"),
          new CrawlerUrlDTO("https://il.srgssr.ch/integrationlayer/2.0/srf/mediaComposition/video/18a0ec86-4829-44e0-8261-d647d7907c7c.json"),
          new CrawlerUrlDTO("https://il.srgssr.ch/integrationlayer/2.0/srf/mediaComposition/video/001f4ea3-72a0-40d1-ad6e-1e584f0b9222.json"),
          new CrawlerUrlDTO("https://il.srgssr.ch/integrationlayer/2.0/srf/mediaComposition/video/d588365b-b2e8-47ff-9e23-1ae2510c6f97.json"),
          new CrawlerUrlDTO("https://il.srgssr.ch/integrationlayer/2.0/srf/mediaComposition/video/63ff41bb-5ab3-4b3a-bc02-5bea921447dc.json"),
          new CrawlerUrlDTO("https://il.srgssr.ch/integrationlayer/2.0/srf/mediaComposition/video/de2b5dc4-e5b5-4ba0-a05d-a2ce4ce1bb46.json"),
          new CrawlerUrlDTO("https://il.srgssr.ch/integrationlayer/2.0/srf/mediaComposition/video/99dbaab8-36e3-4f12-bf5f-34f197ed0777.json")
        }      
      },
  ...
  public SrfSendungOverviewJsonDeserializerTest(String aJsonFile, Optional<String> aExpectedNextPageId, CrawlerUrlDTO[] aExpectedUrls) {
    jsonFile = aJsonFile;
