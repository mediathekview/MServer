...
/*        {
  ...
  public ZdfDownloadDtoDeserializerTest(final String aJsonFile,
      final String aExpectedUrlSmall, final String aExpectedUrlNormal, final String aExpectedUrlHd,
      final String aExpectedUrlSmallEnglish, final String aExpectedUrlNormalEnglish, final String aExpectedUrlHdEnglish,
      final Optional<String> aExpectedSubtitle, final Optional<GeoLocations> aExpectedGeo) {
    jsonFile = aJsonFile;
  ...
  public void test() {
    ...
    AssertFilm.assertUrl(expectedUrlSmall, dto.getUrl(ZdfConstants.LANGUAGE_GERMAN, Resolution.SMALL));
    AssertFilm.assertUrl(expectedUrlNormal, dto.getUrl(ZdfConstants.LANGUAGE_GERMAN, Resolution.NORMAL));
    AssertFilm.assertUrl(expectedUrlHd, dto.getUrl(ZdfConstants.LANGUAGE_GERMAN, Resolution.HD));
    AssertFilm.assertUrl(expectedUrlSmallEnglish, dto.getUrl(ZdfConstants.LANGUAGE_ENGLISH, Resolution.SMALL));
    AssertFilm.assertUrl(expectedUrlNormalEnglish, dto.getUrl(ZdfConstants.LANGUAGE_ENGLISH, Resolution.NORMAL));
    AssertFilm.assertUrl(expectedUrlHdEnglish, dto.getUrl(ZdfConstants.LANGUAGE_ENGLISH, Resolution.HD));
